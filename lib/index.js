...
const { NAME = 'feedbackfruits-knowledge-search-broker-v26', ELASTICSEARCH_ADDRESS = 'http://localhost:9200', GIZMO_ENDPONT = 'http://staging-fbf-cayley.herokuapp.com/api/v1/query/gizmo', KNOWLEDGE_ADDRESS = 'https://staging-api.explain.direct', KAFKA_ADDRESS = 'tcp://kafka:9092', INPUT_TOPIC = 'staging_quad_updates', ELASTICSEARCH_INDEX_NAME = 'knowledge', } = process.env;
const memux = require("memux");
const rxjs_1 = require("@reactivex/rxjs");
const PQueue = require("p-queue");
const elasticsearch = require("elasticsearch");
const node_fetch_1 = require("node-fetch");
const { empty } = rxjs_1.Observable;
