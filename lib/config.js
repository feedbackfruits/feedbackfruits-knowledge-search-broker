...
const { NODE_ENV = 'development', NAME = 'feedbackfruits-knowledge-search-broker', CAYLEY_ADDRESS = 'http://localhost:64210', KNOWLEDGE_ADDRESS = 'https://staging-api.explain.direct', KAFKA_ADDRESS = 'tcp://localhost:9092', INPUT_TOPIC = 'staging_updates', ELASTICSEARCH_ADDRESS = 'http://localhost:9200', ELASTICSEARCH_INDEX_NAME = 'knowledge', ELASTICSEARCH_USE_ALIASES = true } = process.env;
...
exports.ELASTICSEARCH_USE_ALIASES = ELASTICSEARCH_USE_ALIASES;
function getVersion() {
